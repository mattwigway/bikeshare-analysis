...
in data/data-cleaned-labeled-sample.csv. As a sample, some analyses
may not work correctly; for instance, there may not be trips
originating from every station.
