...
project is licensed under the Apache License. Sample data is available
in data/data-cleaned-labeled-sample.csv; it can be used for input to
both \reflst{relabel.R} and \reflst{morans\string_i.R}. As a sample,
some analyses may not work correctly; for instance, there may not be
trips originating from every station.
